<%@ Page Title="" Language="C#" MasterPageFile="~/Main.Master" AutoEventWireup="true" 
    CodeBehind="WIPXraySampling.aspx.cs" Inherits="SGST.INE.WIP.WIPXraySampling" %>
                ...
                <div class="box-body">
                    <div class="row">
                        <div class="col-md-6">
                            ...
                            <div class="col-xs-3">
                                <asp:Button ID="btnOK" runat="server" class="btn btn-primary btn-block btn-flat" Text="OK" OnClick="btnOK_Click" OnClientClick="Confirm()" />
                            </div>
                            <div class="col-xs-3">

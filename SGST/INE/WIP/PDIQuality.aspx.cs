...
{
    public partial class PDIQuality : System.Web.UI.Page
    {
        string Message = "";
        BL_PDIQuality blobj = null;
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            {
                string _strRights = CommonHelper.GetRights("PDI QUALITY", (DataTable)Session["USER_RIGHTS"]);
        ...
        protected void btnOK_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                blobj = new BL_PDIQuality();
                DataTable dt = blobj.SaveQualtiyData(txtReelID.Text.Trim()
        ...
        protected void btnReject_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                blobj = new BL_PDIQuality();
                DataTable dt = blobj.SaveQualtiyData(txtReelID.Text.Trim(), drpFGItemCode.Text, sDefect, drpstation.Text, txtObservation.Text, "0"
                     , Session["SiteCode"].ToString(), Session["LINECODE"].ToString()
                    , Session["UserID"].ToString()
                    );
                if (dt.Rows.Count > 0)

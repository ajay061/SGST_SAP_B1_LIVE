...
{
    public partial class RMCustomerReturn : System.Web.UI.Page
    {
        BL_RMUWGoodsIssueToShopFlor_StockTransfer blobj = new BL_RMUWGoodsIssueToShopFlor_StockTransfer();
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            try
            {
                ...
                {
                    string _strRights = CommonHelper.GetRights("ISSUE TO CUSTOMER", (DataTable)Session["USER_RIGHTS"]);
        ...
        public void BindOrderNo()
        {
            ...
            try
            {
                blobj = new BL_RMUWGoodsIssueToShopFlor_StockTransfer();
            ...
            try
            {
                if (checkField() == false)
                {
                    ...
                    if (gvSupplierReturn.Rows.Count >= 0)
                    {
                        ...
                        DataTable dtResult = blobj.SaveCustomerReturnData(
                            ...
                            Session["UserID"].ToString(), Session["SiteCode"].ToString(), Session["LINECODE"].ToString()
                            );

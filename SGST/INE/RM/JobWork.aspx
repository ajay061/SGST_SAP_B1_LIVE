<%@ Page Title="" Language="C#" MasterPageFile="~/Main.Master" AutoEventWireup="true" 
    CodeBehind="JobWork.aspx.cs" Inherits="SGST.INE.Operation.JobWork" EnableEventValidation="false" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
            <h1 id="head1" runat="server">Job Work     
            </h1>
        </section>
        <!-- Main content -->
                ...
                <div class="box-header with-border">
                    <div class="form-row">
                        <div class="form-group col-md-6">
                            ...
                            <div>
                                <asp:DropDownList ID="drpOrderNumber" runat="server" class="form-control select2" Style="width: 100%;" AutoPostBack="true" OnSelectedIndexChanged="drpOrderNumber_SelectedIndexChanged1">
                                </asp:DropDownList>
                            </div>
                        </div>
                        <div class="form-group col-md-6">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-12">
                            <div class="form-group">
                                <asp:GridView ID="gvJobWork" runat="server" class="table table-striped table-bordered table-hover GridPager" AutoGenerateColumns="false"
                                    AllowPaging="true" PageSize="10" OnPageIndexChanging="gvJobWork_PageIndexChanging" AllowSorting="true">
                                    ...
                                    <Columns>
                                        ...
                                        <asp:BoundField HeaderText="Scan Quantity" DataField="JOB_ISSUED_QTY" HeaderStyle-HorizontalAlign="Left" ItemStyle-HorizontalAlign="Left" ItemStyle-Width="100" />

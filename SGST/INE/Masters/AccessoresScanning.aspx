<%@ Page Title="" Language="C#" MasterPageFile="~/Main.Master" AutoEventWireup="true"
     CodeBehind="AccessoresScanning.aspx.cs" Inherits="SGST.INE.Masters.AccessoresScanning" %>
        ...
        <section class="content">
            <div class="box box-default">
                <div class="box-header with-border">
                    <h3 class="box-title">Accessories Scanning </h3>
                </div>
                <div class="box-body">
                    <div class="row">
                        <div class="col-md-6">
                            ...
                            <div class="form-group">
                                <label>Is Stand Label Scanned : </label>
                                <asp:CheckBox ID="chkStandLabel" runat="server" class="form-control"
                                    Style="width: 100%;" AutoPostBack="true" Checked ="false" OnCheckedChanged="chkStandLabel_CheckedChanged">
                                </asp:CheckBox>
                            </div>
                             <div class="form-group">

<%@ Page Title="" Language="C#" MasterPageFile="~/Main.Master" AutoEventWireup="true"
    CodeBehind="PhysicalStockReport.aspx.cs" Inherits="SGST.INE.Reports.PhysicalStockReport" %>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <asp:DropDownList ID="drpType" runat="server"
                                    ...
                                    <asp:ListItem Text="RM"> </asp:ListItem>
                                    <asp:ListItem Text="WIP">  </asp:ListItem>
                                    <asp:ListItem Text="FG">  </asp:ListItem>
                                </asp:DropDownList>
                            </div>
                        </div>
                    </div>

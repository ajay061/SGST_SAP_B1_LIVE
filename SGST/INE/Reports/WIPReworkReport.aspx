<%@ Page Title="" Language="C#" MasterPageFile="~/Main.Master" AutoEventWireup="true"
    CodeBehind="WIPReworkReport.aspx.cs"
    Inherits="SGST.INE.Reports.WIPReworkReport" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
            <h1>WIP Rework Report     
            </h1>
        </section>
        <section class="content">
            <div class="box box-default">
                <div class="box-header with-border">
                    <h3 class="box-title">WIP Rework Report</h3>
                ...
                <div class="box-body">
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <asp:DropDownList ID="drpMachineID" runat="server" class="form-control select2" Style="width: 100%;">
                                </asp:DropDownList>
                            </div>
                        </div>
                        <div class="col-md-6">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <asp:DropDownList ID="drpType" runat="server" class="form-control select2" Style="width: 100%;">
                                    <asp:ListItem>Repair In</asp:ListItem>
                                    <asp:ListItem>Repair Out</asp:ListItem>
                                </asp:DropDownList>
                            </div>
                    ...
                    <div class="row">
                     <div class="col-md-6">
                            <div class="form-group">
                                <label>Rework Station </label>
                                <asp:DropDownList ID="REWORK_STATION_ID" runat="server" class="form-control select2" Style="width: 100%;">
                                </asp:DropDownList>
                            </div>
                        </div>
                     </div>
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                <label>PCB Barcode :</label>
                                <asp:TextBox ID="txtPCBID" runat="server" class="form-control"  Style="width: 100%;"
                                    autocomplete="off">                                 
                                </asp:TextBox>
                            </div>
                        </div>

<%@ Page Title="" Language="C#" MasterPageFile="~/Main.Master" AutoEventWireup="true"
    CodeBehind="WIPPcbTrackingNew.aspx.cs" Inherits="SGST.INE.Reports.PcbTrackingNew" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
            <h1>PCB Tracking Report      
            </h1>
        </section>
        <section class="content">
            <div class="box box-default">
                <div class="box-header with-border">
                    <h3 class="box-title">PCB Tracking Report</h3>
                ...
                <div class="box-body">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <asp:DropDownList ID="drpType" runat="server" OnSelectedIndexChanged="drpType_SelectedIndexChanged" class="form-control select2" Style="width: 100%;" AutoPostBack="true">
                                    ...
                                    <asp:ListItem Text="PCB Barcode">  </asp:ListItem>
                                    <asp:ListItem Text="RM Barcode">  </asp:ListItem>
                                    <asp:ListItem Text="RM Batch No"></asp:ListItem>
                                    <asp:ListItem Text="RM GRPO No"></asp:ListItem>
                                </asp:DropDownList>
                            </div>
                        </div>
                    </div>
                    <div class="row" runat="server" id="divDate">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <asp:DropDownList ID="drpFGitemCode" runat="server" class="form-control select2" Style="width: 100%;" AutoPostBack="true">
                                </asp:DropDownList>
                            </div>
                        </div>
                     ...
                     <div class="row" >
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <asp:DropDownList ID="drpReportDisplay" runat="server" class="form-control"
                                    autocomplete="off">                                   
                    ...
                    <div class="row" runat="server" id="DivPCB">
                        <div class="col-md-6">
                            <div class="form-group">
                                <label>Scan PCB Barcode</label>
                                <asp:TextBox ID="txtPCBBarcode" runat="server" AutoPostBack="true" class="form-control"
                                    autocomplete="off"></asp:TextBox>
                            </div>
                        </div>
                    </div>
                    <div class="row" runat="server" id="divRMBarcode">
                        <div class="col-md-6">
                            <div class="form-group">
                                <label>Scan RM Barcode</label>
                                <asp:TextBox ID="txtRMBarcode" runat="server" AutoPostBack="true" class="form-control" autocomplete="off"></asp:TextBox>
                            </div>
                        </div>
                    </div>
                    <div class="row" runat="server" id="divRMBatchNo">
                        <div class="col-md-6">
                            <div class="form-group">
                                <label>Enter RM Batch No</label>
                                <asp:TextBox ID="txtRMBatchNo" runat="server" class="form-control" autocomplete="off"></asp:TextBox>
                            </div>
                        </div>
                    </div>
                    <div class="row" runat="server" id="divGRPONo">
                        <div class="col-md-6">
                            <div class="form-group">
                                <label>Enter GRPO No</label>
                                <asp:TextBox ID="txtGrpoNo" runat="server" class="form-control" autocomplete="off"></asp:TextBox>
                            </div>
                        </div>
                    </div>
                </div>

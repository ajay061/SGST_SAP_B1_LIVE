<%@ Page Title="" Language="C#" MasterPageFile="~/Main.Master" AutoEventWireup="true" CodeBehind="ASNWifiAPSAPReport.aspx.cs" 
    Inherits="SGST.INE.Reports.ASNWifiAPSAPReport" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
            <h1> Wifi AP SAP  Report</h1>
        </section>
        <section class="content">
            <div class="box box-default">
                <div class="box-header with-border">
                    <h3 class="box-title">Wifi AP SAP Report</h3>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <asp:TextBox ID="TextModelNo" runat="server" Class="form-control"></asp:TextBox>
                            </div>
                        </div>
                    </div>
                </div>

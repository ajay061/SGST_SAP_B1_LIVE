...
{
    public partial class WIPPrimaryPackingReport : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            {
                string _strRights = CommonHelper.GetRights("PRIMARY PACKING REPORT", (DataTable)Session["USER_RIGHTS"]);
        ...
        private void BindFGItemCode()
        {
            try
            {
                BL_PrimaryPackingReports blobj;
                blobj = new BL_PrimaryPackingReports();
        ...
        protected void btnShow_Click(object sender, EventArgs e)
        {
            ...
            {
                CommonHelper.ShowCustomErrorMessage(ex.Message, msgerror); CommonHelper.mBcilLogger.LogMessage(BcilLib.EventNotice.EventTypes.evtError, System.Reflection.MethodBase.GetCurrentMethod().Name, ex.Message);
            }
        }
        private void ShowGridData()
        {
            try
            {
                ...
                BL_PrimaryPackingReports blobj = new BL_PrimaryPackingReports();
                DataTable dtTrackingData = blobj.GetReport(txtFromDate.Text, txtToDate.Text, sFGItemCode,txtBoxID.Text.Trim());
                if (dtTrackingData.Rows.Count > 0)
                {
                    ...
                    CommonHelper.mBcilLogger.LogMessage(BcilLib.EventNotice.EventTypes.evtMessage,
                          System.Reflection.MethodBase.GetCurrentMethod().Name, "Packing Report No of records :" + dtTrackingData.Rows.Count);

                    ReportViewer1.ProcessingMode = ProcessingMode.Local;
                    ReportDataSource datasource = new ReportDataSource();
                    ReportViewer1.LocalReport.ReportPath = Server.MapPath("~/ReportViewer/WIPBoxPackingReport.rdlc");
                    ...
                    {
                        OrderNo = dtTrackingData.Rows[0]["Box_ID"].ToString();
                        sItemCode = dtTrackingData.Rows[0]["FG_ITEM_CODE"].ToString();
                        Desc = dtTrackingData.Rows[0]["FG_ITEM_DESC"].ToString();
                    }

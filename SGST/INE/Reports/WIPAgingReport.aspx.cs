...
{
    public partial class WIPAgingReport : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            if(Session["usertype"].ToString() != "ADMIN")
            {
                string _strRights = CommonHelper.GetRights("AGEING REPORT", (DataTable)Session["USER_RIGHTS"]);
        ...
        private void BindPart_No()
        {
            try
            {
                BL_AgingReport blobj;
                blobj = new BL_AgingReport();
        ...
        protected void btnShow_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                DataTable dtTrackingData = blobj.getReport(
                    txtFromDate.Text, txtToDate.Text, sPartCode,drpReportType.Text);
                ...
                else
                {
                    ...
                    ReportViewer1.LocalReport.ReportPath = Server.MapPath("~/ReportViewer/AgingReport.rdlc");
                    datasource = new ReportDataSource("AGINGREPORT", dtTrackingData);
                    ...
                    ReportParameter paramete1 = new ReportParameter("rptWorkOrderNo", "");

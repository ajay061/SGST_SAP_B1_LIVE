...
{
    public partial class PDIReport : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            {
                string _strRights = CommonHelper.GetRights("PDI QUALITY REPORT", (DataTable)Session["USER_RIGHTS"]);
        ...
        private void BindFGItemCode()
        {
            try
            {
                ...
                DataTable dtGRN = blobj.BindpdiFGItemCode();
        ...
        private void ShowGridData()
        {
            try
            {
                ...
                DataTable dtTrackingData = blobj.GetpdiReport(txtFromDate.Text, txtToDate.Text, sFGItemCode, txtPCBBarcode.Text.Trim());
                if (dtTrackingData.Rows.Count > 0)
                {
                    ...
                    CommonHelper.mBcilLogger.LogMessage(BcilLib.EventNotice.EventTypes.evtMessage,
                          System.Reflection.MethodBase.GetCurrentMethod().Name, "PDI Sampling Report No of records :" + dtTrackingData.Rows.Count);

                    ReportViewer1.ProcessingMode = ProcessingMode.Local;
                    ReportDataSource datasource = new ReportDataSource();
                    ReportViewer1.LocalReport.ReportPath = Server.MapPath("~/ReportViewer/WIPPDISamplingReport.rdlc");

<%@ Page Title="" Language="C#" MasterPageFile="~/Main.Master" AutoEventWireup="true"
    CodeBehind="RMInventoryReport.aspx.cs" Inherits="SGST.INE.Reports.RMReceivingNewReport" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
            <h1>RM Inventory Report       
            </h1>
        </section>
        <section class="content">
            <div class="box box-default">
                <div class="box-header with-border">
                    <h3 class="box-title">RM Inventory Report</h3>
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <asp:TextBox ID="txtGRPONo" runat="server"
                            ...
                            <div class="form-group">
                                ...
                                <asp:DropDownList ID="drpLocationType" runat="server"
                                    class="form-control select2" Style="width: 100%;">
                                    <asp:ListItem>Under Quality</asp:ListItem>

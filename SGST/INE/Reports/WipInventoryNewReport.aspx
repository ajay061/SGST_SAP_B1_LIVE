<%@ Page Title="" Language="C#" MasterPageFile="~/Main.Master" AutoEventWireup="true"
    CodeBehind="WipInventoryNewReport.aspx.cs" Inherits="SGST.INE.Reports.WipInventoryNewReport" %>
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <asp:DropDownList ID="drpPartCode" runat="server" class="form-control select2" Style="width: 100%;" AutoPostBack="true"></asp:DropDownList>
                            </div>
                        </div>
                    </div>
                    <br />

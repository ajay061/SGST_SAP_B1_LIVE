<%@ Page Title="" Language="C#" MasterPageFile="~/Main.Master" AutoEventWireup="true"
    CodeBehind="RMIssueReportNew.aspx.cs" Inherits="SGST.INE.Reports.RMIssueReportNew" %>
        ...
        <section class="content">
            <div class="box box-default">
                <div class="box-header with-border">
                    <h3 class="box-title">RM Issue Report </h3>
                ...
                <div class="box-body">
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                <label>Enter RM Grpo No.:</label>
                                <asp:TextBox ID="txtRMGRPONo" runat="server"
                                    class="form-control" Style="width: 100%;" autocomplete="off"></asp:TextBox>
                            </div>
                        </div>
                    </div>

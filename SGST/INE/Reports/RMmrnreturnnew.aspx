<%@ Page Title="" Language="C#" MasterPageFile="~/Main.Master" AutoEventWireup="true" CodeBehind="RMmrnreturnnew.aspx.cs" Inherits="SGST.INE.Reports.mrnreturnnew" %>
        ...
        <section class="content">
            ...
            <div class="box box-default">
                <div class="box-header with-border">
                    <h3 class="box-title">Return Report</h3>
                ...
                <div class="box-body">
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                <label>From Date:</label><asp:Label ID="Label1" runat="server" Text="*" ForeColor="Red"></asp:Label>
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                <label>
                                    To Date:<asp:Label ID="Label2" runat="server" Text="*" ForeColor="Red"></asp:Label>
                                </label>
                                &nbsp;<div class="input-group">
                                    <div class="input-group-addon">
                                        <i class="fa fa-calendar"></i>

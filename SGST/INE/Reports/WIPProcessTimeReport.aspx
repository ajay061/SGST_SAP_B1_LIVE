<%@ Page Title="" Language="C#" MasterPageFile="~/Main.Master" AutoEventWireup="true" CodeBehind="WIPProcessTimeReport.aspx.cs" Inherits="SGST.INE.Reports.WIPProcessTimeReport" %>
        ...
        <section class="content">
            ...
            <div class="box box-default">
                <div class="box-header with-border">
                    <h3 class="box-title">Process Time Report </h3>
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <asp:DropDownList ID="drpFG" runat="server" class="form-control select2" Style="width: 100%;" AutoPostBack="true"></asp:DropDownList>
                            </div>
                            <div class="form-group">
                                <label>From </label>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <asp:DropDownList ID="drpMachine" runat="server" class="form-control select2"  AutoPostBack="false" Style="width: 100%;">
                                </asp:DropDownList>
                                <asp:Label ID="lblMachineType" Visible="false" runat="server"></asp:Label>
                            </div>
                            <div class="form-group">
                                <label>
                                    To 

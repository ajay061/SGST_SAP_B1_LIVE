<%@ Page Title="" Language="C#" MasterPageFile="~/Main.Master" AutoEventWireup="true" CodeBehind="FGLoadingDispatchreportNew.aspx.cs" Inherits="SGST.INE.Reports.LoadingDispatchreportNew" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
            <h1>Loading and Dispatch Report      
            </h1>
        </section>
        <!-- Main content -->
        <section class="content">
            ...
            <div class="box box-default">
                <div class="box-header with-border">
                    <h3 class="box-title">Loading and Dispatch</h3>

<%@ Page Title="" Language="C#" MasterPageFile="~/Main.Master" AutoEventWireup="true"
     CodeBehind="WIPQualityReport.aspx.cs" Inherits="SGST.INE.Reports.WIPQualityReport" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
            <h1>Quality Data Report       
            </h1>
        </section>
        <section class="content">
            <div class="box box-default">
                <div class="box-header with-border">
                    <h3 class="box-title">FG Quality Data Report</h3>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <asp:TextBox ID="txtWorkOrderNo" runat="server" class="form-control" autocomplete="off"
                                    Style="width: 100%;">
                                </asp:TextBox>
                            </div>
                        </div>                         

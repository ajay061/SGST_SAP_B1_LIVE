<%@ Page Title="" Language="C#" MasterPageFile="~/Main.Master" AutoEventWireup="true"
    CodeBehind="SAPPostingReport.aspx.cs" Inherits="SGST.INE.Reports.SAPPostingReport" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
            <h1>SAP Posting Data Report</h1>
        </section>
        <section class="content">
            <div class="box box-default">
                <div class="box-header with-border">
                    <h3 class="box-title">SAP Posting Data Report</h3>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <asp:DropDownList ID="drpType" runat="server" class="form-control select2" Style="width: 100%;">
                                    <asp:ListItem Text="RM Quality Posting"> </asp:ListItem>
                                    <asp:ListItem Text="RM Issue Posting">  </asp:ListItem>
                                    <asp:ListItem Text="FG Posting">  </asp:ListItem>
                                    <asp:ListItem Text="FG Quality Posting">  </asp:ListItem>
                                    <asp:ListItem Text="Work Order Close">  </asp:ListItem>
                                </asp:DropDownList>
                            </div>
                        </div>
                        <div class="col-md-6">

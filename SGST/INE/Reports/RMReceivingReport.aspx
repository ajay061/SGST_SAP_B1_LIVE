<%@ Page Title="" Language="C#" MasterPageFile="~/Main.Master" AutoEventWireup="true"
    CodeBehind="RMReceivingReport.aspx.cs" Inherits="SGST.INE.Reports.RMReceivingReport" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
            <h1>RM Receiving Report       
            </h1>
        </section>
        <section class="content">
            <div class="box box-default">
                <div class="box-header with-border">
                    <h3 class="box-title">RM Receiving Report </h3>
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                <label>GRPO No.:</label>
                                <asp:TextBox ID="txtGRPONO" runat="server" class="form-control" AutoComplete="off"
                                    Style="width: 100%;"></asp:TextBox>
                            </div>
                            <div class="form-group">
                                <label>Item Code:</label>
                                <asp:DropDownList ID="drpItemCode" runat="server" class="form-control select2" Style="width: 100%;"></asp:DropDownList>
                            </div>
                            <div class="form-group">
                                <label>Scan Location:</label>
                                <asp:TextBox ID="txtLocation" runat="server" class="form-control" autocomplete="off" Style="width: 100%;"></asp:TextBox>
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <asp:DropDownList ID="drpData" runat="server" class="form-control select2"
                                    Style="width: 100%;">
                                    <asp:ListItem>--Select--</asp:ListItem>
                                    <asp:ListItem>Pending GRPO</asp:ListItem>
                                    <asp:ListItem>Pending Quality</asp:ListItem>
                                    <asp:ListItem>Pending Putaway</asp:ListItem>
                                    <asp:ListItem>GRPO Completed</asp:ListItem>
                                    <asp:ListItem>Putway Completed</asp:ListItem>
                                    <asp:ListItem>Quality Passed</asp:ListItem>
                                </asp:DropDownList>
                            </div>
                        </div>
                    </div>

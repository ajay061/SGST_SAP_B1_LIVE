...
{
    public class DL_RMUWGoodsIssueToShopFlor_StockTransfer
    {
        DBManager oDbm;
        public DL_RMUWGoodsIssueToShopFlor_StockTransfer()
        {
        ...
        public DataTable BindPONO(string sSiteCode)
        {
            ...
            try
            {
                ...
                dt = oDbm.ExecuteDataSet(System.Data.CommandType.StoredProcedure, "USP_RM_STOCK_TRANSFER").Tables[0];
            }
            catch (Exception ex)
            {
        ...
        public DataTable ValidateCustomerData(string sPONo, string sPartCode, string sItemLineNo

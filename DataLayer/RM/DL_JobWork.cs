    ...
    public class DL_JobWork
    {
        ...
        public DataTable BindPONO(string sSiteCode)
        {
            ...
            try
            {
                ...
                dt = oDbm.ExecuteDataSet(System.Data.CommandType.StoredProcedure, "USP_RM_JOB_WORK_SGST").Tables[0];
            }
            catch (Exception ex)
            {
        ...
        public DataTable GetDetails(string sPONo, string sPartCode, string sItemLineNo,string sSiteCode)
        {
            DataTable dt = new DataTable();
            try
            {
        ...
        public DataTable ValidateJobBarcode(string sPONo, string sPartCode, string sItemLineNo
